...
#
# Generated by export_simulation on Tue Mar 12 16:00:34 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './ZAES.sh' script.
...
./ZAES.sh -noclean_files

For more information on the script, please type './ZAES.sh -help'.
