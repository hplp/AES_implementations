// ==============================================================
// File generated on Wed Apr 10 18:00:04 -0400 2019
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module SubBytes_cipher_rom (
...
initial begin
    $readmemh("./SubBytes_cipher_rom.dat", ram0);
    $readmemh("./SubBytes_cipher_rom.dat", ram1);
    $readmemh("./SubBytes_cipher_rom.dat", ram2);
    $readmemh("./SubBytes_cipher_rom.dat", ram3);
    $readmemh("./SubBytes_cipher_rom.dat", ram4);
    $readmemh("./SubBytes_cipher_rom.dat", ram5);
    $readmemh("./SubBytes_cipher_rom.dat", ram6);
    $readmemh("./SubBytes_cipher_rom.dat", ram7);
end
...
SubBytes_cipher_rom SubBytes_cipher_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
