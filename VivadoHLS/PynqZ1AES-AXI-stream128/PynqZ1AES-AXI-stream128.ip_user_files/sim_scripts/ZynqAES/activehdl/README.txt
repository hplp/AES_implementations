...
#
# Generated by export_simulation on Thu Apr 11 15:44:50 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './ZynqAES.sh' script.

./ZynqAES.sh -reset_run
...
./ZynqAES.sh -noclean_files

For more information on the script, please type './ZynqAES.sh -help'.
