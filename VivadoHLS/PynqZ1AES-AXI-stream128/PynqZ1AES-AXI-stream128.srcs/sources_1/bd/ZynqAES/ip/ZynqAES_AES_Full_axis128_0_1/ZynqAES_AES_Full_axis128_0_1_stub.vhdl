...
-- Date        : Thu Apr 11 15:47:23 2019
-- Host        : HPLP-SM7ED running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               D:/WS/AES_implementations/VivadoHLS/PynqZ1AES-AXI-stream128/PynqZ1AES-AXI-stream128.srcs/sources_1/bd/ZynqAES/ip/ZynqAES_AES_Full_axis128_0_1/ZynqAES_AES_Full_axis128_0_1_stub.vhdl
...
entity ZynqAES_AES_Full_axis128_0_1 is
  Port ( 
    ...
    aes_in_TVALID : in STD_LOGIC;
    aes_in_TREADY : out STD_LOGIC;
    aes_in_TDATA : in STD_LOGIC_VECTOR ( 127 downto 0 );
    aes_in_TLAST : in STD_LOGIC_VECTOR ( 0 to 0 );
    aes_out_TVALID : out STD_LOGIC;
    aes_out_TREADY : in STD_LOGIC;
    aes_out_TDATA : out STD_LOGIC_VECTOR ( 127 downto 0 );
    aes_out_TLAST : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
attribute black_box_pad_pin of stub : architecture is "s_axi_AES_AWADDR[4:0],s_axi_AES_AWVALID,s_axi_AES_AWREADY,s_axi_AES_WDATA[31:0],s_axi_AES_WSTRB[3:0],s_axi_AES_WVALID,s_axi_AES_WREADY,s_axi_AES_BRESP[1:0],s_axi_AES_BVALID,s_axi_AES_BREADY,s_axi_AES_ARADDR[4:0],s_axi_AES_ARVALID,s_axi_AES_ARREADY,s_axi_AES_RDATA[31:0],s_axi_AES_RRESP[1:0],s_axi_AES_RVALID,s_axi_AES_RREADY,ap_clk,ap_rst_n,interrupt,aes_in_TVALID,aes_in_TREADY,aes_in_TDATA[127:0],aes_in_TLAST[0:0],aes_out_TVALID,aes_out_TREADY,aes_out_TDATA[127:0],aes_out_TLAST[0:0]";
