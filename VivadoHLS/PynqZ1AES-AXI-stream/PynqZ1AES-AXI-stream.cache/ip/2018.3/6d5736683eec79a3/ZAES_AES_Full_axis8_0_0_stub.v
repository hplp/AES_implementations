...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ ZAES_AES_Full_axis8_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_AES_AWADDR, s_axi_AES_AWVALID, 
  ...
  data_in_TVALID, data_in_TREADY, data_in_TDATA, data_out_TLAST)
/* synthesis syn_black_box black_box_pad_pin="s_axi_AES_AWADDR[4:0],s_axi_AES_AWVALID,s_axi_AES_AWREADY,s_axi_AES_WDATA[31:0],s_axi_AES_WSTRB[3:0],s_axi_AES_WVALID,s_axi_AES_WREADY,s_axi_AES_BRESP[1:0],s_axi_AES_BVALID,s_axi_AES_BREADY,s_axi_AES_ARADDR[4:0],s_axi_AES_ARVALID,s_axi_AES_ARREADY,s_axi_AES_RDATA[31:0],s_axi_AES_RRESP[1:0],s_axi_AES_RVALID,s_axi_AES_RREADY,ap_clk,ap_rst_n,interrupt,data_out_TVALID,data_out_TREADY,data_out_TDATA[7:0],data_in_TVALID,data_in_TREADY,data_in_TDATA[7:0],data_out_TLAST" */;
