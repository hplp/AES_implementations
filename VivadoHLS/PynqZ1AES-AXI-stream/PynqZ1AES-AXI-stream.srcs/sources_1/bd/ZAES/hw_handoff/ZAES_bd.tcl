...
proc create_root_design { parentCell } {
  ...
  set AES_Full_0 [ create_bd_cell -type ip -vlnv UVA_HPLP:HLS:AES_Full:1.0 AES_Full_0 ]
  ...
  connect_bd_intf_net -intf_net AES_Full_0_data_out [get_bd_intf_pins AES_Full_0/data_out] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AES_Full_0/data_in] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AES_Full_0/s_axi_AES/Reg] SEG_AES_Full_0_Reg
