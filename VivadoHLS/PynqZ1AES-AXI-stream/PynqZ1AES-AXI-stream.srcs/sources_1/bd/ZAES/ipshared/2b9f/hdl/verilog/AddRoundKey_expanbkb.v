// ==============================================================
// File generated on Wed Apr 10 22:10:46 -0400 2019
...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module AddRoundKey_expanbkb_rom (
...
initial begin
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram0);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram1);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram2);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram3);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram4);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram5);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram6);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram7);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram8);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram9);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram10);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram11);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram12);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram13);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram14);
    $readmemh("./AddRoundKey_expanbkb_rom.dat", ram15);
end
...
parameter AddressRange = 32'd624;
...
AddRoundKey_expanbkb_rom AddRoundKey_expanbkb_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
